<!-- Property Content -->
<div class="tab-pane fade" id="terminal" role="tabpanel" aria-labelledby="v-pills-terminal-tab">
	<!-- All Property Info -->
	<div class="tr-single-box">

		<div class="tr-single-header">
			<h4><i class="ti-share"></i> Terminals </h4>
							...
							<tr>
								...
								<td>
									<div class="btn-group fl-right">
										...
										<div class="dropdown-menu pull-right animated flipInX">
											<a href="javascript:void(0)" class="login" data-toggle="modal" data-target="#addTerminal">Add</a>
    										<a href="javascript:void(0)" class="login" data-toggle="modal" data-target="#editTerminal">Edit</a>
                                            <a href="javascript:void(0)" class="login" data-toggle="modal" data-target="#deleteTerminal">Delete</a>
										</div>
									</div>
								</td>
							</tr>
